...
class MainWindow(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        menuAbout = filemenu.Append(wx.ID_ABOUT, "&关于", \
       ...
       # 设置events
        ...
        self.Bind(wx.EVT_BUTTON, self.OnButton0, btn)
        self.Bind(wx.EVT_BUTTON, self.OnButton0, funbtn)
    ...
    def OnOpen(self, e):
        ...
        #                    wildcard, style, pos)
        dlg = wx.FileDialog(self, "Choose a file", self.dirname, "", "*.*", wx.POPUP_WINDOW)
